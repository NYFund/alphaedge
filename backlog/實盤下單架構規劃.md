...
> - 驗證：`uv run pytest` 2203 passed；ruff、三支檢查腳本、pre-commit 全綠；**tick 冒煙**：以 `login_read_only_sessions()` 登入正式環境（唯讀、不寫 `data/`），`StockTickCrawler` 抓 2330 在 2026-09-18 共 4,824 筆，欄位與 Shioaji 升級 S6 當時相同。
