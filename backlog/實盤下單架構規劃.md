...
>
> **恢復下一步**：開通期貨 API 權限，再於交易日盤中送兩筆 ROD 限價單驗證。
...
> - **缺的是逐筆派送本身**：「每收到一筆 tick 就呼叫一次策略鉤子」要等 Phase5-2 的
>   盤中事件迴圈，而「同一份錄製 tick 餵兩次訊號一致」也要有迴圈才驗得動。
>   在那之前本步驟維持 🔄。
